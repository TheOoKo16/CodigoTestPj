...
namespace Infra.Helper
{
    ...
    {
        public static String API_URL = "https://localhost:44324/";
        //public static String API_URL = "http://webinarapi.azurewebsites.net/";  
    }
    ...
    public class ApiRequest<T>
    {
        ...
        public static async Task<T> PostRequest(string url,string accessToken, T entity, string rootUrl = null)
        {
            if (rootUrl != null)
            {
                API_URL = rootUrl;
